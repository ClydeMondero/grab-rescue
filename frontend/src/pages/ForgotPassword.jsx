...
const ForgotPassword = () => {
  ...
  const handleForgotPassword = (event) => {
    ...
    // Logic to handle password reset for Admin or Rescuer
    if (role === "admin") {
      console.log("Sending password reset for Admin");
      // Add logic to send a reset link for admin
    } else if (role === "rescuer") {
      console.log("Sending password reset for Rescuer");
      // Add logic to send a reset link for rescuer
    }
  };
