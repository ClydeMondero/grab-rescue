      ...
      <div className="flex-1 bg-white rounded-lg p-3">
        ...
        <form className="space-y-2" onSubmit={handleSubmit}>
          <div className="relative">
            ...
            >
              {showPasswords.currentPassword ? <FaEyeSlash size={20} color="#557C55" /> : <FaEye size={20} color="#557C55" />}
            </button>
          </div>
          <div className="relative">
            ...
            >
              {showPasswords.newPassword ? <FaEyeSlash size={20} color="#557C55" /> : <FaEye size={20} color="#557C55" />}
            </button>
          </div>
          <div className="relative">
            ...
            >
              {showPasswords.confirmPassword ? <FaEyeSlash size={20} color="#557C55" /> : <FaEye size={20} color="#557C55" />}
            </button>
          </div>
          <button 
            type="submit" 
