...
//TODO: add select with options Default = "", Ascending = asc, Descending = desc
const GenerateReports = (props) => {
  ...
  const openModal = (report) => {
    ...
    // Set default start and end dates based on the selected report
  ...
  const generatePDF = (logs) => {
    ...
    doc.setFontSize(12);
    doc.text(`Generated by: ${user?.first_name} ${user?.last_name}`, 10, 20);
    doc.text(`Generated date: ${new Date().toLocaleString()}`, 10, 25);
